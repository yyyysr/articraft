...
def test_sdk_docs_profile_exposes_compact_production_references() -> None:
    ...
    assert "sdk/_docs/common/30_articulated_object.md" not in base_docs
    assert "sdk/_docs/common/35_physics_parameters.md" not in base_docs
    assert "sdk/_docs/common/80_testing.md" not in base_docs
    assert "sdk/_docs/base/40_mesh_geometry.md" not in base_docs
    ...
    assert "sdk/_docs/base/46_section_lofts.md" not in base_docs
    assert "sdk/_docs/cadquery/35_cadquery.md" not in base_docs
